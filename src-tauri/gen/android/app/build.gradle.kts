...
android {
    compileSdk = 36
    namespace = "moe.mutsumi.mail"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "moe.mutsumi.mail"
        minSdk = 24
        targetSdk = 36
...
gradle.taskGraph.whenReady(Action {
    ...
    if (runsReleaseBuild && !hasReleaseSigning) {
        throw GradleException(
            "Release builds require src-tauri/gen/android/keystore.properties; " +
                "use the fixed release keystore rather than an unsigned package."
        )
    }
})
